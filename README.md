...
If this is your first time using virtual reality, take your time learning everything. Make sure you are situated with the headset and controller before jumping into all the more complicated components of SyGlass.

## The Headset

### Head Strap:
In the back of your headset, there is a knob that controls the tightness of the headset around your head. Use this knob to adjust the headset to a point where it's comfortable and allows you to see through the lenses.

### Lens Distance Dial:
Underneath the front of the controller, right above your nose, is a dial that adjusts the distance between the two lenses inside your headset. Adjust this dial until you can clearly see through both lenses without them being blurry or unclear.

## The Controllers

This section will review the primary buttons on your controllers and their functionality, including their functionality with SyGlass.

### Trigger:
- The trigger allows you to utilize the selected tool for each controller and move around your project or other objects in your VR environment. The trigger will enable you to choose options in the menu and controller menu and adjust the visualization settings. The trigger is your key to interacting with SyGlass's various user interfaces.

### Touchpad:
- Pressing down on the touchpad enables the radial menu. With the radial menu, you can select different abilities or settings for the current tool on each controller. To choose an option from the radial menu, move your controller to the option, and press the trigger.
...
### Power Button:
- The power button is under an MPFI Logo sticker on your controller. To turn your controller on, press down on the sticker until you hear a beep and the lights on your controller turn on. Hold down on this button again to turn the controller off.

### Grip Button:
- The grip button is a button on the base of your controller, where your middle finger may lay. Each controller can have two different SyGlass "tools" bound to them simultaneously. Pressing the grip button allows you to cycle between these two tools. For example, your controller will default to have the Transform and CutPlane tools selected. Pressing the grip button will cycle between these two tools.

# SyGlass Specifics

## Importing projects
To import a project into SyGlass, navigate to the **file** button at the top menu bar. From there, if creating a new project, select the "create new project" button. Otherwise, select "Import Existing Project."
...
To load multiple projects into the same environment, hold down the **control** button on your keyboard and left-click on the projects you would like to import to highlight them. Once you select your desired projects, right-click while still holding control and press "Launch Project."
...
After loading your project, you can change the project's visualization settings using an interactive menu. Each volume you import will be different, so you may need to adjust the visualization settings to have it show correctly to your viewer.
...
### Selecting Tools
After the menu is opened by pressing the menu button, you will see two rows of tools at the bottom. Pointing at one of these buttons with your controller and pressing your trigger will select it. You're able to choose two tools at a time. The first tool you select will be your "main" tool, and the second will be your "secondary" tool. Pressing the Grip button on your controller allows you to switch between these two tools.

### Transform Tool
The transform tool is used to move meshes and volumes around your environment. By default, with the transform tool selected, grabbing in the air allows you to move around all meshes and volumes in the scene, while grabbing inside of a volume allows you to move and rotate it individually. 
...
To remove a cut plane, hold the trigger down and move the plane away from the volume.
...
Once you have selected a mesh, it should have a yellow outline around it. You are only able to select one at a time. To move the mesh, use the transform tool, and the "transform surfaces only" function.

### Studio Tool
The studio tool is your interface with everything to do with recording. By pressing down on your trigger, your camera will go into "selfie stick mode" by attaching itself to a pole to your controller. You can increase and decrease this distance by using the lengthen and shorten options on your radial menu to place your camera where you'd like.

In the menu, more options can be used to help with recording. For example, the "Font Size" selector allows you to increase or decrease the font size of your scripts as they appear on your teleprompter. The teleprompter is covered more in this guide's "Podium" section, including turning it on and off and selecting which script you'd like displayed.
...
Under the "Video" tab, scroll to "Capture Resolution." This selection allows you to change the aspect ratio of your video before exporting. The higher the ratio, the higher quality your video will be. However, reaching higher values may cause your videos to take more time to render.

### Controller & Headset Smoothing
Under the "Controller" tab, scroll to "Headset Smoothing" and "Controller Smoothing." These settings allow you to add "smoothness" to your movements in virtual reality, making your recording have smoother movement of your hands and head. Adding some smoothing to your controllers and headset is essential. Without it, your actions may seem jerky, distracting, or disorienting.
...
A new radial menu will appear by turning your wrist to face you on your left controller (as if you were checking a watch). The **podium** tool is handy when recording, sporting many functions to make your narration experience a breeze. The podium tool is only available with the VR mode of SyGlass enabled.
...
### Teleprompter
The teleprompter allows you to see and scroll through your scripts while recording. A joystick labeled "move teleprompter" allows you to move the teleprompter by dragging it forward, backward, left, or right. Options to change scripts or display the full current script on the teleprompter also appear on the podium.

## Exporting Recordings
### Recording MP4s
Once you have finished a narration, you can export it as an Mp4 video. To do this, right-click on your recording in the narration menu and press "Record Mp4." These videos may take some time to render, so don't be alarmed if the wait time is long or SyGlass seems like it's crashing. Once your video is done rendering, it can be found in a folder named "syglass" in your computer's video directory.

### Creating Presentations
Presentations allow you to stitch multiple narrations together before exporting. Click on the "Create Presentation" button under the File tab in the top menu bar. Select and arrange the narrations you would like to combine on the timeline. 
